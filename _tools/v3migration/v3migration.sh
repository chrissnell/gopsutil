...
# usage: cd ${GOPATH}/src/github.com/chrissnell/gopsutil && bash tools/v3migration/v3migration.sh
...
###  change import path
find . -name "*.go" -print0 | xargs -0 -I@ sed -i 's|"github.com/chrissnell/gopsutil/|"github.com/chrissnell/gopsutil/v3/|g' @
